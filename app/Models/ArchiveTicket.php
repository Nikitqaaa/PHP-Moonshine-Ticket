...
final class ArchiveTicket extends Model
{
    protected $primaryKey = 'id';

    protected $table = 'archive_tickets_aggregated';
    ...
    {
        $table = "archive_tickets_view_{$year}";
    ...
    /**
     * Получить отдел к которому пренадлежит заявка.
     */
     ...
     */
    public function archiveComments(): HasMany
    {
        return $this->hasMany(ArchiveComment::class, 'ticket_id', 'id');
    }
}
